---
page_title: "github_agents_secret (Resource) - GitHub"
subcategory: ""
description: |-
  Resource to manage a GitHub Agents secret for a repository.
---

# github_agents_secret (Resource)

Resource to manage a GitHub Agents secret for a repository.

-> You must have write access to a repository to use this resource. See the [REST API endpoints for agent secrets](https://docs.github.com/rest/agents/secrets) for the required token scopes and permissions.
...
```shell
terraform import github_agents_secret.example repo-name:secret-name
```
