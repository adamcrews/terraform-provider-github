...
func TestAccGithubAgentsOrganizationSecretsDataSource(t *testing.T) {
	...
	t.Run("success", func(t *testing.T) {
		...
		_ = mustCreateTestOrganizationAgentsSecret(t)
			...
			Steps: []resource.TestStep{
				{
					...
					ConfigStateChecks: []statecheck.StateCheck{
						statecheck.ExpectKnownValue("data.github_agents_organization_secrets.test", tfjsonpath.New("secrets"), knownvalue.ListPartial(map[int]knownvalue.Check{
