			...
			Steps: []resource.TestStep{
				{
					...
					Check: resource.ComposeTestCheckFunc(
						resource.TestCheckResourceAttrPair("github_agents_organization_secret_repositories.test", "secret_name", "github_agents_organization_secret.test", "secret_name"),
						resource.TestCheckResourceAttr("github_agents_organization_secret_repositories.test", "selected_repository_ids.#", "2"),
					),
				},
			},
		})
